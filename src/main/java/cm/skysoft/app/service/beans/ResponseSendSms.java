...
public class ResponseSendSms {
    ...
    public ResponseSendSms(String statut, Long cout, String description,
                          String ssidSms) {
        super();
        this.statut = statut;
        this.cout = cout;
    ...
    public ResponseSendSms(String statut, String description) {
        super();
        this.statut = statut;
        this.cout = 0L;
        this.solde = (double) 0;
    ...
    public ResponseSendSms(String statut, String description, Double solde) {
        super();
        this.statut = statut;
        this.cout = 0L;
        this.solde = solde;
    ...
    public void add(ResponseSendSms r) {
