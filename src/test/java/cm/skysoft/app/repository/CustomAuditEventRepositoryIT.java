...
import cm.skysoft.app.SpringBootJwtWithSocialMedia;
import cm.skysoft.app.audit.AuditEventConverter;
import cm.skysoft.app.domain.PersistentAuditEvent;
...
import static cm.skysoft.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
import static org.assertj.core.api.Assertions.assertThat;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = SpringBootJwtWithSocialMedia.class)
@Transactional
public class CustomAuditEventRepositoryIT {
    ...
    public void addAuditEventWithAnonymousUser() {
        Map<String, Object> data = new HashMap<>();
        data.put("test-key", "test-value");
        AuditEvent event = new AuditEvent(ConstantsUtils.ANONYMOUS_USER, "test-type", data);
        customAuditEventRepository.add(event);
        List<PersistentAuditEvent> persistentAuditEvents = persistenceAuditEventRepository.findAll();
